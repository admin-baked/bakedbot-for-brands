...
exports.VibeProjectProvider = void 0;
...
class VibeProjectProvider {
    ...
    async getChildren(element) {
        ...
        try {
            ...
            return projects.map((project) => new ProjectTreeItem(project.name, project.id, vscode.TreeItemCollapsibleState.None));
        }
        catch (error) {
...
exports.VibeProjectProvider = VibeProjectProvider;
class ProjectTreeItem extends vscode.TreeItem {
    constructor(label, projectId, collapsibleState) {
