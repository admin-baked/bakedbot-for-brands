...
**Current Status:** 🟢 `main` green; SES primary email + custom domain; $0 Free plan + sidebar gating; GCP health gated ➔ deploy | **Last update:** 2026-04-05 (Linus Identity + CI Stabilization `c7b3e9a`)
