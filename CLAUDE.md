...
**Current Status:** 🟢 Passing | **Last update:** 2026-02-24 (Jina AI integration: Reader/Search/Reranker pipeline; CannMenus API as Tier 1 competitor pricing; parseLeafly() overhaul; monthly freq gate for unpaid orgs)
