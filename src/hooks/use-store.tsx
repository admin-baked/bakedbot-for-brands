...
export function useStore<T>(selector: (state: StoreState) => T): T {
  ...
  // This is the key part for handling hydration
  const [isHydrated, setIsHydrated] = useState(false);
  
  useEffect(() => {
    const unsubscribe = store.persist.onRehydrate(() => {
        setIsHydrated(true);
    });
  ...
  const serverState = useZustandStore(createHydratableStore(getDefaultInitialState()), selector);
