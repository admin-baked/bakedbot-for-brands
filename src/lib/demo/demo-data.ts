...
export const demoProducts: Product[] = [
  ...
  },
  {
    ...
    description: 'Juicy watermelon flavored gummy bites. 5mg THC per piece for a controllable and pleasant experience.',
    likes: 340,
    dislikes: 2,
    brandId: 'default',
  },
  {
    ...
    description: 'A soothing blend of THC and CBN designed to help you drift off to sleep naturally. easy-to-dose dropper.',
    likes: 180,
    dislikes: 0,
    brandId: 'default',
  }
