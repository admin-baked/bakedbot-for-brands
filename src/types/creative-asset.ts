...
export const ASSET_TEMPLATES: Record<string, Omit<AssetTemplate, 'id'>> = {
  ...
  // COMPLIANCE ADS
  weedmaps_banner: {
    name: 'Weedmaps Listing Banner Pack',
    description: 'Desktop and mobile Weedmaps listing banners with editable promo copy',
    category: 'compliance',
    format: 'image',
    platforms: ['web', 'mobile_app'],
    dimensions: { width: 2560, height: 800, unit: 'px' },
    aspectRatio: '2560:800',
    complianceLevel: 'high',
    requiredDisclaimers: ['21+', 'State license number'],
    aiModel: 'gemini-flash',
    estimatedCost: 0.02,
    generationTime: 5,
    features: ['Desktop + mobile presets', 'Editable promo copy', 'License/disclaimer fields', 'PNG/JPG export'],
    tags: ['compliance', 'weedmaps', 'listing', 'banner'],
    isPremium: false,
    conversionOptimized: true,
  },
