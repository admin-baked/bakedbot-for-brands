...
3. Test connection
4. Map categories (POS → BakedBot standard categories)
5. Enable sync
...
**Symptoms:**
- New products in POS don't appear in BakedBot
...
**Symptoms:**
- Prices in BakedBot don't match POS
...
3. Verify product appears in BakedBot
4. Check all fields populated correctly

**Test 2: Price Change**
1. Change product price in POS
2. Wait for sync
3. Verify price updated in BakedBot
...
2. Wait for sync
3. Verify description updated in BakedBot
