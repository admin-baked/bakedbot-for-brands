...
Keep your AI agents sharp with automated memory maintenance—BakedBot Intelligence automatically detects stale memories, resolves conflicts, and optimizes memory quality without manual intervention.

## What is Memory Health?

**Memory health is how well your agents remember and use information:**
- 🧹 **Auto-Gardening** - Automatic cleanup of outdated or low-value memories
- ⚔️ **Conflict Detection** - Identifies contradictory facts across memories
- 📊 **Health Scoring** - 0-100 score based on staleness, conflicts, and completeness
- ⏰ **Relevance Decay** - Memories age naturally—older = less relevant
- 🔍 **Semantic Analysis** - AI determines which memories matter most
- 📈 **Continuous Optimization** - Weekly scheduled maintenance keeps agents sharp
...
- ❌ **Stale facts** - Outdated pricing, discontinued products, old promotions
- ❌ **Conflicting data** - "Store opens at 9am" vs "Store opens at 10am"
- ❌ **Low-value memories** - Repeated greetings, trivial conversations
- ❌ **Expired information** - Seasonal campaigns, limited-time offers
...
**Example:**
- 🟢 **Keep:** "Customer prefers indica strains for sleep issues" (semantic score: 0.92)
- 🔴 **Prune:** "User said hello" (semantic score: 0.12)
...
→ Similarity: 0.95 (same topic: store hours)
```
...
**Access:** CEO Dashboard → MERIDIAN tab → Memory Health section
...
**How to trigger:**
1. **CEO Dashboard → MERIDIAN → Memory Health**
...
- Health score <60 → **Warning** (yellow notification)
- Health score <40 → **Alert** (red notification)
- Stale memories >50 → **Warning**
- Conflicts >5 → **Alert**
...
**Auto-actions:**
- Health <40 → Trigger immediate gardening
- Conflicts >10 → Flag for manual review
...
- **Inference:** Lowest confidence—verify with external data
...
**Fix:**
1. Increase **Pruning Threshold** (default 0.30 → 0.40)
2. Increase **Decay Constant** (default 60 days → 90 days)
