...
Complete guide to integrating Alleaves POS with BakedBot for automatic menu sync, inventory management, and order processing.
...
<Callout type="info">
**Important:** Alleaves has multiple price columns. BakedBot syncs the price type you select. Most dispensaries use "Adult-Use OTD" which includes tax and is the final price customers pay.
</Callout>
...
Map Alleaves categories to BakedBot:

```
Alleaves Category → BakedBot Category
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
FLOWER → Flower
...
**Custom mappings:**
- Map multiple Alleaves categories to one BakedBot category
...
Adult-Use OTD: $35.00 ← This syncs to BakedBot
...
**Symptoms:**
- Products in Alleaves don't appear in BakedBot
...
```
In BakedBot: Settings → POS → Category Mapping
...
**Symptoms:**
- Stock levels in BakedBot don't match Alleaves
- Sales in Alleaves don't reflect in BakedBot
...
```
In BakedBot: Re-enter Alleaves credentials
...
**Central inventory:**
- BakedBot aggregates across locations
...
**What doesn't sync:**
- Product images (add manually in BakedBot)
- Extended descriptions
- Effects/flavors (add in BakedBot)
- Customer reviews

**Enhancing synced products:**
1. Sync brings basic data from Alleaves
2. Edit in BakedBot to add:
   - High-quality images
...
- BakedBot: Sales analytics, marketing metrics
