...
export interface LinusIncidentSlackMessage {
    ...
    fallbackText: string;
    source: 'auto-escalator' | 'support-ticket' | 'server-error' | 'client-error' | 'marty-ceo-briefing' | 'marty-meeting-reminder' | 'marty-problem-report' | 'marty-followup-cadence' | 'agent-dream-review' | 'agent-dream-batch' | 'dayday-seo-report' | 'campaign-monitor' | 'ses-webhook';
