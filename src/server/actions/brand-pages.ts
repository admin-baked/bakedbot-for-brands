...
const BRAND_PAGE_ROLES = ['brand', 'dispensary', 'dispensary_admin', 'dispensary_staff', 'super_user', 'super_admin'] as const;
...
export async function getBrandPage(
    ...
    try {
        const user = await requireUser([...BRAND_PAGE_ROLES]);
