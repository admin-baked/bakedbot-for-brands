...
import { defineTools } from '@genkit-ai/ai/model';
import { z } from 'zod';
import {
...
export const buildMonitorTools = defineTools({
    metadata: {
        description: 'Build monitoring and deployment failure diagnosis tools for CTO',
        category: 'operations'
    }
},
{
