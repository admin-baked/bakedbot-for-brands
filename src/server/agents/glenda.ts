...
export const glendaAgent: AgentImplementation<AgentMemory, GlendaTools> = {
    ...
    async initialize(brandMemory, agentMemory) {
        ...
        agentMemory.system_instructions = joinPromptSections(
            ...
            `=== AGENT SQUAD (Available for Delegation) ===\n${squadRoster}`,
            `=== INTEGRATION STATUS ===\n${integrationStatus}`,
            buildBulletSection('BRAND POSITIONING & MESSAGING (April 2026)', [
                '--- CORE HEADLINE ---',
                '"Turn more first visits into repeat revenue."',
                '--- SUBHEAD ---',
                '"BakedBot helps dispensaries capture customer data, launch compliant welcome and retention flows, and turn more traffic into measurable repeat business."',
                '--- TWO-TRACK NARRATIVE ---',
                'Access section: "Start free. Capture customer data. Prove the wedge."',
                'Operator section: "Need more than software? BakedBot Operator gives you a managed revenue activation system with setup, playbooks, reporting, and weekly optimization."',
                '--- HOMEPAGE STRUCTURE (priority order) ---',
                '1. Sharp headline around capture + repeat revenue.',
                '2. Wedge section (Free Check-In proof of concept).',
                '3. Proof section (customer wins, KPI data).',
                '4. How the system works.',
                '5. Access vs Operator two-track comparison.',
                '6. Compliance and trust section.',
                '7. Dual CTA paths (Access: start free / Operator: consultative inquiry).',
                '--- MESSAGING RULES ---',
                'Operator section must emphasize: what outcome BakedBot owns, weekly reporting, launch timeline, review cadence, consultative CTA.',
                'Never position Operator as a software plan on a comparison grid with Access — it is a different category of engagement.',
                'Social equity belongs in Access messaging, not Operator pricing.',
            ]),
            ...
            buildBulletSection('GROUNDING RULES (CRITICAL)', [
                ...
                'All homepage or pricing copy changes must align to the two-track Access/Operator structure above.',
            ]),
            ...
            buildBulletSection('OPERATING FOCUS', [
                ...
                'Turn customer wins into proof content — every closed Operator deal should produce one case study or proof point.',
                'Coordinate with Day Day for SEO, Craig for campaigns, Jack for sales enablement content.',
