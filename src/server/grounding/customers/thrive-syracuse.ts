 ...
 *
 * Single source of truth for evaluating Smokey's performance at Thrive Syracuse.
 * Version 1.0 | January 2026
 *
 * Owner: Ade Adeyemi
 * Location: 3065 Erie Blvd E, Syracuse, NY 13224
 * BakedBot URL: bakedbot.ai/thrivesyracuse
...
export const thriveGroundTruth: GroundTruthQASet = {
    ...
    categories: {
        ...
        product_pairings_and_upsells: {
            description: 'Product pairing suggestions and upsell scenarios using cannabis science',
            qa_pairs: [
                {
                    id: 'UP-001',
                    question: 'What pairs well with this indica flower?',
                    ideal_answer: 'Great choice! Indica flower pairs well with a calming edible like our melatonin gummies or a linalool-rich tincture. The terpenes work together for a deeper relaxation experience — this is called the entourage effect. Want me to find a specific pairing from our menu?',
                    context: 'Terpene-based product pairing for indica',
                    intent: 'Find complementary products',
                    keywords: ['pairs', 'indica', 'entourage effect', 'terpenes', 'linalool', 'myrcene', 'relaxation'],
                    priority: 'high',
                },
                {
                    id: 'UP-002',
                    question: 'Do you have any bundles or deals on multiple products?',
                    ideal_answer: 'Yes! We offer curated bundles that pair products using cannabis science. For example, our Sleep Starter Pack combines indica flower with calming edibles and a tincture at a discounted price. Check our current deals for available bundles — they save you money while giving you products that genuinely work well together.',
                    context: 'Bundle availability and value',
                    intent: 'Find bundle deals',
                    keywords: ['bundles', 'deals', 'save', 'paired', 'discount', 'Sleep Starter Pack'],
                    priority: 'high',
                },
                {
                    id: 'UP-003',
                    question: 'I bought a sativa vape, what else should I try?',
                    ideal_answer: 'Since you enjoy sativa vapes, you might like a sativa pre-roll for a different consumption experience with similar uplifting effects. If your vape has limonene or pinene terpenes, look for flower or edibles with similar profiles — they complement each other for focus and energy. I can search our menu for the best match!',
                    context: 'Cross-category sativa pairing',
                    intent: 'Find complementary sativa products',
                    keywords: ['sativa', 'vape', 'pre-roll', 'limonene', 'pinene', 'energy', 'focus', 'cross-category'],
                    priority: 'high',
                },
                {
                    id: 'UP-004',
                    question: 'What should I add to my cart for pain relief?',
                    ideal_answer: 'For comprehensive pain relief, consider stacking products with complementary terpenes. A caryophyllene-rich flower pairs well with a CBD topical for localized relief. Myrcene-dominant edibles can add a body-relaxing layer. This combination targets pain through multiple pathways. Want me to find specific products in stock?',
                    context: 'Pain relief product stacking',
                    intent: 'Build a pain relief regimen',
                    keywords: ['pain relief', 'caryophyllene', 'CBD', 'topical', 'myrcene', 'stacking', 'body'],
                    priority: 'high',
                },
                {
                    id: 'UP-005',
                    question: 'Can you suggest something to go with my edibles?',
                    ideal_answer: 'Edibles pair great with tinctures for layered effects — the tincture kicks in faster (15-30 min) while the edible builds gradually (1-2 hours). For a relaxation session, try a linalool tincture with your indica edibles. For a social vibe, a sativa pre-roll complements euphoric edibles nicely. What effects are you going for?',
                    context: 'Edible complementary products',
                    intent: 'Find products to pair with edibles',
                    keywords: ['edibles', 'tincture', 'pairing', 'layered', 'onset', 'pre-roll', 'complementary'],
                    priority: 'medium',
                },
            ],
        },
    ...
    maintenance_schedule: {
        weekly: [
            'Review Smokey chat logs for new question patterns',
