...
const DEMO_PRODUCTS: Product[] = [
  {
    ...
    price: 45,
    imageUrl: 'https://picsum.photos/seed/40t-black-market-indica/400/400',
    imageHint: 'cannabis flower indica',
    category: 'Flower',
    thcPercent: 28,
    cbdPercent: 0.5,
    strainType: 'Indica',
  ...
  },
  {
    ...
    price: 55,
    imageUrl: 'https://picsum.photos/seed/40t-justice-sativa/400/400',
    imageHint: 'cannabis flower sativa',
    category: 'Flower',
    thcPercent: 24,
    cbdPercent: 0.1,
    strainType: 'Sativa',
  ...
  },
  {
    ...
    price: 25,
    imageUrl: 'https://picsum.photos/seed/40t-freedom-gummies-berry/400/400',
    imageHint: 'cannabis gummies berry',
    category: 'Edibles',
    thcPercent: 10,  // mg
    cbdPercent: 0,
    strainType: 'Hybrid',
