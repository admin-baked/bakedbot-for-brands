                        ...
                        <CardHeader>
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex-1">
                                    <p className="text-sm font-semibold">Review for <Link href={`/menu/${review.productBrandId}/products/${review.productId}`} className="text-primary hover:underline">{review.productName}</Link></p>
