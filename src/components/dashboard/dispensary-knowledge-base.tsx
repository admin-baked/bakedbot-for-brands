...
import { Loader2, Plus, Book, Trash2, Link as LinkIcon, FileText, Database, ShieldCheck } from 'lucide-react';
...
interface DispensaryKnowledgeBaseProps {
    dispensaryId: string;
}

export function DispensaryKnowledgeBase({ dispensaryId }: DispensaryKnowledgeBaseProps) {
    ...
    const loadKbs = async () => {
        setLoading(true);
        try {
            const kbs = await getKnowledgeBasesAction(dispensaryId);
    ...
    const handleCreateKb = async () => {
        ...
        try {
            const result = await createKnowledgeBaseAction({
                ownerId: dispensaryId,
                ownerType: 'dispensary',
                name: newKbName,
                description: `Dispensary Knowledge Base`
            });
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight text-slate-900">Dispensary Context</h2>
                    <p className="text-slate-500">Train BakedBot on your SOPs, menus, and dispensary guidelines.</p>
                </div>
                ...
                <Dialog open={isCreateKbOpen} onOpenChange={setIsCreateKbOpen}>
                    ...
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>Group related documents (e.g. "Employee Handbook", "Daily Procedures").</DialogDescription>
                        </DialogHeader>
                        <div className="space-y-4 py-4">
                            <div className="space-y-2">
                                <Label>Name</Label>
                                <Input value={newKbName} onChange={e => setNewKbName(e.target.value)} placeholder="e.g. Front Desk SOPs" />
                            </div>
                        </div>
                        <DialogFooter>
                    ...
                    <CardHeader className="flex flex-row items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <CardDescription>
                                    Only available to your dispensary agents.
                                </CardDescription>
                            </div>
                        </div>
                        <Dialog open={isAddDocOpen} onOpenChange={setIsAddDocOpen}>
                            ...
                            <DialogContent className="max-w-2xl">
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        BakedBot will use this context to answer your questions accurately.
                                    </DialogDescription>
                                </DialogHeader>
                                <div className="space-y-4 py-4">
