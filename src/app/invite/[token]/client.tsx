...
export function JoinPageClient({ invitationToken }: { invitationToken: string }) {
    ...
    useEffect(() => {
        async function checkToken() {
            try {
                const res = await validateInvitationAction(invitationToken);
    ...
    const handleAccept = async () => {
        ...
        setStatus('accepting');
        try {
            const res = await acceptInvitationAction(invitationToken);
            if (res.success) {
                setStatus('success');
