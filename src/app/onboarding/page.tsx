    ...
    const handleNextStep = async () => {
        ...
        try {
            if (step === 'role') {
                ...
                // *** FIX: Call the server action to complete onboarding ***
                ...
                await user.getIdToken(true); // Force refresh the token on the client
            ...
            toast({ variant: "destructive", title: "An error occurred", description: error.message || "Could not save your information. Please try again." });
        } finally {
            setIsSubmitting(false);
        }
    };
        ...
        <div className="min-h-screen bg-muted/40 flex items-center justify-center p-4">
            <Card className="w-full max-w-lg shadow-lg">
                ...
                <CardContent className="space-y-8">
                   ...
                   {step === 'role' && (
                       <div className="space-y-4 animate-in fade-in-50" data-testid="onboarding-step-role">
                    ...
                    {step === 'location' && (
                       <div className="space-y-4 animate-in fade-in-50" data-testid="onboarding-step-location">
                   ...
                   {step === 'products' && (
                       <div className="space-y-4 text-center animate-in fade-in-50" data-testid="onboarding-step-products">
                ...
                <CardFooter className="justify-between">
                     <Button variant="ghost" onClick={() => role === 'customer' ? setStep('role') : setStep('role')} disabled={step === 'role'}>
                        Back
                    </Button>
