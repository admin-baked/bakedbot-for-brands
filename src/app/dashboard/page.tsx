...
export default function DashboardPage() {
  ...
  return (
    <div className="flex min-h-screen bg-[#0c0707] text-gray-100">
      {/* Left sidebar */}
      <aside className="w-60 bg-[#140b0b] border-r border-white/5 flex flex-col">
        <div className="flex items-center gap-2 px-4 py-4 border-b border-white/5">
          <div className="h-7 w-7 rounded-lg bg-orange-500 flex items-center justify-center text-xs font-bold">
            B
          </div>
        ...
        <nav className="flex-1 overflow-y-auto px-2 py-4 space-y-1 text-sm">
          ...
          <NavItem label="Smokey Chat" />
          <NavItem label="The Sanctum" />
        ...
        <div className="px-3 pb-4 space-y-3">
          <div className="bg-gradient-to-br from-purple-700/80 via-orange-500/70 to-amber-400/70 rounded-xl p-3 text-xs">
            <div className="font-semibold mb-1">Upgrade your plan!</div>
            <p className="text-[11px] mb-2">
              Unlock more agents, experiments, and premium support.
            </p>
            <button className="w-full rounded-lg bg-black/70 text-[11px] py-1.5 font-medium hover:bg-black text-orange-100">
              View Plans
            </button>
          </div>

          <div className="flex items-center gap-2 text-xs px-1">
            <div className="h-7 w-7 rounded-full bg-gray-700 flex items-center justify-center text-[11px]">
              MK
            </div>
      ...
      <div className="flex-1 flex flex-col">
        {/* Top bar */}
        <header className="h-14 border-b border-white/5 flex items-center justify-between px-6 bg-[#120909]">
          ...
          <div className="flex items-center gap-3 text-xs">
            <div className="relative">
              <input
                ...
                className="bg-[#1e1211] border border-white/10 rounded-full pl-8 pr-3 py-1.5 text-[11px] focus:outline-none focus:border-orange-400/70 placeholder:text-gray-500 min-w-[200px]"
              />
            ...
            <button className="px-1.5 py-0.5 rounded-full border border-white/10 text-[10px]">
              EN
            </button>
            <button className="px-1.5 py-0.5 rounded-full border border-transparent text-[10px] text-gray-500">
              ES
            </button>
        ...
        <main className="flex-1 overflow-y-auto px-8 py-8 space-y-8">
          ...
          <section className="bg-[#171012] border border-white/10 rounded-2xl px-6 py-5 flex flex-col gap-3">
            <div className="flex justify-between items-center gap-4">
              <div className="space-y-1">
                <div className="text-xs tracking-wide text-orange-300 flex items-center gap-1">
              ...
              <button className="hidden md:inline-flex items-center justify-center rounded-lg bg-orange-500 px-4 py-1.5 text-xs font-semibold hover:bg-orange-400">
                Create Agent
              </button>
            </div>
            ...
            <div className="flex gap-2 mt-1">
              <div className="relative flex-1">
                <span className="absolute left-3 top-2.5 text-orange-300 text-xs">
                  🧠
                </span>
                <input
                  type="text"
                  placeholder="e.g., Send a daily summary of cannabis industry news to my email."
                  className="w-full bg-black/30 border border-white/10 rounded-lg pl-7 pr-3 py-2 text-xs placeholder:text-gray-500 focus:outline-none focus:border-orange-400/70"
                />
              </div>
              <button className="inline-flex items-center justify-center rounded-lg bg-orange-500 px-4 py-2 text-xs font-semibold hover:bg-orange-400 md:hidden">
                Create
              </button>
            </div>
          </section>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
              <div className="flex-1 max-w-md">
                <input
                  ...
                  className="w-full bg-[#171012] border border-white/10 rounded-lg px-3 py-2 text-xs placeholder:text-gray-500 focus:outline-none focus:border-orange-400/70"
                />
              </div>
              <div className="flex items-center gap-3 text-xs">
                <div className="flex items-center gap-1">
                ...
                <button className="px-3 py-1 rounded-lg bg-[#171012] border border-white/10 text-xs font-medium hover:border-orange-400/70">
                  Create Manually
                </button>
              </div>
            </div>
...
function NavItem({
  ...
  return (
    ...
    >
      ...
      {locked && (
        <span className="text-[11px] text-gray-500 ml-2">🔒</span>
      )}
    </button>
  );
}
    ...
    <button
      ...
      className={[
        ...
        active
          ...
          : 'bg-transparent border-white/10 text-gray-400 hover:border-orange-400/70 hover:text-gray-100',
      ].join(' ')}
    >
      {label}
    </button>
...
function PlaybookCard({
  ...
  return (
    <article className="bg-[#171012] border border-white/10 rounded-2xl px-4 py-4 flex flex-col gap-3">
      <div className="flex items-center justify-between text-[11px]">
        <button className="inline-flex items-center gap-1 text-gray-300">
