    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h2 className="text-xl font-semibold">Your Carousels</h2>
                    <p className="text-sm text-muted-foreground">Manage featured product collections.</p>
                </div>
            ...
            <div className="grid gap-4">
                {carousels.length === 0 ? (
                    <div className="p-12 border border-dashed rounded-lg bg-card/50 text-center text-muted-foreground flex flex-col items-center">
                        ...
                        <p className="mb-4 max-w-sm">Create a carousel to feature specific products on your menu.</p>
                        <Button onClick={handleCreateOpen} variant="outline">Create Carousel</Button>
                    </div>
                ) : (
