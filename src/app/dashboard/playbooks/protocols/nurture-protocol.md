...
- **Tier 3 (Volume)**:
  ...
  - **Action**: Automated Nurture Sequence managed by **Craig**.

## 2. Nurture Sequences (Managed by Craig + Mrs. Parker)

### Sequence A: "The Value Add" (Tier 3)
*Goal: Drive user to 'Claim Page' twice.*
- **Day 0**: Welcome + "Claim Your Page" link (Email).
- **Day 2**: "Did you see your competitor?" (Email - via Ezal data).
- **Day 5**: 10% Off First Month Coupon (SMS).

### Sequence B: "The Partner Path" (Tier 2)
*Goal: Schedule a Demo.*
- **Day 0**: Personal intro from "Martez" (Automated by Craig).
...
- **Craig**: Executes the actual sending of content.
