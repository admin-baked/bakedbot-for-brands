...
export default function BrandSettings() {
    const { chatbotIcon, setChatbotIcon } = useStore();
    ...
    const handleIconUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            reader.onloadend = () => {
                setChatbotIcon(reader.result as string);
            };
            ...
            <CardContent className="space-y-6">
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        <Input id="hex-code" placeholder="#FFFFFF" className="pl-8" />
                    </div>
                </div>
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        <Input id="brand-url" placeholder="https://your-brand.com" className="pl-8" />
                    </div>
                </div>
                <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative h-16 w-16 rounded-full border-2 border-dashed border-muted-foreground/50 flex items-center justify-center">
                            {chatbotIcon ? (
                                <Image src={chatbotIcon} alt="Custom Icon" layout="fill" className="rounded-full object-cover" />
                            ) : (
