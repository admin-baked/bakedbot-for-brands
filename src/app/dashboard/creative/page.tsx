...
export default function CreativeCommandCenter() {
  ...
  useEffect(() => {
    ...
    if (!brandGuide || loading || isGenerating || content.length > 0 || localContent) return;
    ...
    const autoPrompt = brandName
      ? `Introduce ${brandName} to our community. Highlight what makes us unique and invite customers to explore our menu. ${selectedImageStyle || 'warm inviting dispensary lifestyle photography, natural light'}`
      : `Introduce our dispensary to the community. Share our passion for quality cannabis and wellness. warm inviting dispensary lifestyle photography, natural light`;
