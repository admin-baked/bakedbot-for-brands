...
const GoogleIcon = () => (
    <svg className="mr-2 h-4 w-4" viewBox="0 0 48 48">
        ...
        <path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303c-.792 2.447-2.275 4.482-4.288 5.942l6.19 5.238C42.021 35.798 44 30.027 44 24c0-1.341-.138-2.65-.389-3.917z" />
    </svg>
);
