...
export default function LoyaltyTabletPage() {
    ...
    const resetIdleTimer = useCallback(() => {
        ...
        if (step !== 'welcome' && step !== 'success' && !recsLoading && !loading) {
            idleTimer.current = setTimeout(resetToWelcome, IDLE_TIMEOUT_MS);
        }
    }, [step, recsLoading, loading, resetToWelcome]);
    ...
    return (
        <div
            className="w-full h-full flex flex-col items-center justify-center p-4 sm:p-8 select-none overflow-y-auto"
                ...
                {step === 'mood' && (
                    ...
                    >
                        <div className="text-center">
                            ...
                            <p className="text-sm sm:text-lg text-purple-300 mt-2">
                        ...
                        <div className="grid grid-cols-2 gap-3 sm:gap-4 w-full">
                            {TABLET_MOODS.map(mood => (
                                <button
                                    ...
                                    className="bg-white/10 hover:bg-purple-500/30 active:bg-purple-500/50 border border-white/20 hover:border-purple-400 rounded-2xl p-3 sm:p-5 flex items-center gap-2 sm:gap-4 transition-all text-left"
                                >
                    ...
                    >
                        {recsLoading ? (
                            <div className="flex flex-col items-center gap-6 py-8 sm:py-12">
                                <Loader2 className="h-12 w-12 sm:h-16 sm:w-16 text-purple-400 animate-spin" />
                                <div className="text-center">
                ...
                {step === 'success' && (
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-base sm:text-xl text-purple-300">
                                {result?.isNewLead
