...
;// ./src/lib/utils.ts
/* unused harmony import specifier */ var clsx;
/* unused harmony import specifier */ var twMerge;
...
function omitUndefinedDeep(value) {
  if (Array.isArray(value)) {
    return value.map((entry) => omitUndefinedDeep(entry)).filter((entry) => entry !== void 0);
  }
  if (isPlainObject(value)) {
    return Object.fromEntries(
      Object.entries(value).filter(([, entry]) => entry !== void 0).map(([key, entry]) => [key, omitUndefinedDeep(entry)]).filter(([, entry]) => entry !== void 0)
    );
  }
  return value;
}
function formatWebsiteLabel(websiteUrl) {
...
const AmbientBackdrop = ({ primaryColor, secondaryColor, accentColor, light = false }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { width, height } = (0,esm.useVideoConfig)();
  const driftX = (0,esm.interpolate)(frame, [0, 60], [-width * 0.05, width * 0.04], {
    easing: esm.Easing.inOut(esm.Easing.ease),
    extrapolateRight: "clamp"
  });
  const driftY = (0,esm.interpolate)(frame, [0, 60], [height * 0.04, -height * 0.03], {
    easing: esm.Easing.inOut(esm.Easing.ease),
    extrapolateRight: "clamp"
  });
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
          position: "absolute",
          inset: 0,
          background: light ? `linear-gradient(135deg, ${hexToRgba("#ffffff", 1)} 0%, ${hexToRgba(accentColor, 0.08)} 45%, ${hexToRgba(primaryColor, 0.12)} 100%)` : `linear-gradient(135deg, ${primaryColor} 0%, ${secondaryColor} 55%, ${accentColor} 130%)`
        }
      }
    ),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
...
const BrandMark = ({ brandName, accentColor, primaryColor, logoUrl, size }) => {
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "div",
        {
          ...
          children: logoUrl ? /* @__PURE__ */ (0,jsx_runtime.jsx)(
            esm.Img,
            {
              src: logoUrl,
              alt: brandName,
...
const IntroScene = ({ brandName, tagline, primaryColor, secondaryColor, accentColor, logoUrl }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps, width, height } = (0,esm.useVideoConfig)();
  const isTall = height > width;
  const cardScale = (0,esm.spring)({ frame, fps, config: { damping: 14, stiffness: 160 } });
  const textLift = (0,esm.interpolate)(frame, [0, 24], [36, 0], {
    easing: esm.Easing.out(esm.Easing.cubic),
    extrapolateRight: "clamp"
  });
  const textOpacity = (0,esm.interpolate)(frame, [0, 20], [0, 1], {
    extrapolateRight: "clamp"
  });
  const lineWidth = (0,esm.interpolate)(frame, [10, 32], [0, isTall ? 160 : 220], {
    easing: esm.Easing.out(esm.Easing.cubic),
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { children: [
                  ...
                  children: [
                    /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      "div",
                      {
                        ...
                        children: "BakedBot Creative Story"
                      }
                    ),
                    /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      "div",
...
const ProductScene = ({ brandName, headline, tagline, primaryColor, secondaryColor, accentColor, productImageUrl }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps, width, height } = (0,esm.useVideoConfig)();
  const isTall = height > width;
  const isSquare = height === width;
  const panelSlide = (0,esm.spring)({ frame, fps, config: { damping: 14, stiffness: 170 } });
  const imageFloat = (0,esm.interpolate)(frame, [0, 64], [16, -12], {
    easing: esm.Easing.inOut(esm.Easing.ease),
    extrapolateRight: "clamp"
  });
  const copyOpacity = (0,esm.interpolate)(frame, [2, 18], [0, 1], {
    extrapolateRight: "clamp"
  });
  const copyShift = (0,esm.interpolate)(frame, [0, 18], [40, 0], {
    easing: esm.Easing.out(esm.Easing.cubic),
    extrapolateRight: "clamp"
  });
  const accentScale = (0,esm.interpolate)(frame, [10, 36], [0.7, 1], {
    easing: esm.Easing.out(esm.Easing.cubic),
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { children: [
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      "div",
                      {
                        ...
                        children: [brandName, "21+ only", "Brand-matched creative"].map((pill) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
                          "div",
                          {
                            style: {
                              padding: "10px 14px",
                      ...
                      children: [
                        /* @__PURE__ */ (0,jsx_runtime.jsx)(
                          "div",
                          {
                            style: {
                              ...
                              borderRadius: 26,
                              overflow: "hidden",
                              background: productImageUrl ? `linear-gradient(160deg, ${hexToRgba("#ffffff", 1)}, ${hexToRgba(accentColor, 0.12)})` : `radial-gradient(circle at 25% 22%, ${hexToRgba(accentColor, 0.36)} 0%, transparent 40%),
                                            linear-gradient(135deg, ${primaryColor}, ${secondaryColor})`
                            },
                            children: productImageUrl ? /* @__PURE__ */ (0,jsx_runtime.jsx)(
                              esm.Img,
                              {
                                src: productImageUrl,
                                alt: headline,
                        ...
                        /* @__PURE__ */ (0,jsx_runtime.jsx)(
                          "div",
                          {
                            ...
                            children: "Built for scroll-stopping visuals"
                          }
                        )
                      ]
                    }
...
const CTAScene = ({ brandName, ctaText, tagline, websiteUrl, primaryColor, secondaryColor, accentColor }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps, width, height } = (0,esm.useVideoConfig)();
  const isTall = height > width;
  const websiteLabel = formatWebsiteLabel(websiteUrl);
  const contentScale = (0,esm.spring)({ frame, fps, config: { damping: 11, stiffness: 180 } });
  const opacity = (0,esm.interpolate)(frame, [0, 14], [0, 1], {
    extrapolateRight: "clamp"
  });
  const lift = (0,esm.interpolate)(frame, [0, 20], [40, 0], {
    easing: esm.Easing.out(esm.Easing.cubic),
    extrapolateRight: "clamp"
  });
  const pulse = 1 + (0,esm.interpolate)(frame, [0, 40], [0, 0.04], {
    easing: esm.Easing.inOut(esm.Easing.ease),
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { children: [
              ...
              /* @__PURE__ */ (0,jsx_runtime.jsxs)(
                "div",
                {
                  ...
                  children: [
                    ...
                    websiteLabel ? /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      "div",
                      {
                        style: {
                          padding: "12px 18px",
...
const BrandedSlideshow = ({
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: primaryColor, fontFamily: "system-ui, sans-serif" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 46, premountFor: 15, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      IntroScene,
      {
        brandName,
        tagline,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 46, durationInFrames: 64, premountFor: 15, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ProductScene,
      {
        brandName,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 110, durationInFrames: 40, premountFor: 15, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      CTAScene,
      {
        brandName,
        ctaText,
...
;// ./src/remotion/compositions/ToolShowcase.tsx




const BackgroundLayer = ({ backgroundImageUrl, primaryColor, secondaryColor, accentColor }) => {
  const isVideo = backgroundImageUrl ? backgroundImageUrl.toLowerCase().endsWith(".mp4") : false;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { children: [
    backgroundImageUrl ? isVideo ? /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Video,
      {
...
const KineticIntro = ({ headline, accentColor }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps, width, height } = (0,esm.useVideoConfig)();
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { alignItems: "center", justifyContent: "center", padding: "0 40px" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { transform: `scale(${scale})`, textAlign: "center" }, children: words.map((word, i) => {
    const wordSpring = (0,esm.spring)({
      frame: frame - i * 3,
      fps,
...
const ScreenshotShowcase = ({ urls, styleMode }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { width, height } = (0,esm.useVideoConfig)();
  const totalFrames = 75;
  const framesPerScreenshot = totalFrames / urls.length;
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { alignItems: "center", justifyContent: "center" }, children: urls.map((url, i) => {
    ...
    if (styleMode === "stop-motion") {
      ...
      const drift = (0,esm.interpolate)(frame, [startFrame, endFrame], [0, -20]);
      transform = `translateY(${drift}px) scale(0.95)`;
      opacity = (0,esm.interpolate)(frame, [startFrame, startFrame + 5, endFrame - 5, endFrame], [0, 1, 1, 0]);
    } else {
      const pop = (0,esm.spring)({ frame: frame - startFrame, fps: 30, config: { damping: 12, stiffness: 200 } });
      transform = `scale(${0.9 + pop * 0.05})`;
      opacity = (0,esm.interpolate)(frame, [startFrame, startFrame + 3, endFrame - 3, endFrame], [0, 1, 1, 0]);
    }
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
...
const ClosureScene = ({ brandName, ctaText, websiteUrl, primaryColor, accentColor }) => {
  const frame = (0,esm.useCurrentFrame)();
  const slide = (0,esm.spring)({ frame, fps: 30, config: { damping: 14, stiffness: 150 } });
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { alignItems: "center", justifyContent: "center", textAlign: "center" }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { transform: `scale(${0.9 + slide * 0.1})`, opacity: slide }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 24, fontWeight: 700, color: "#ffffff", opacity: 0.8, marginBottom: 12 }, children: "Powered by" }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 72, fontWeight: 900, color: "#ffffff", marginBottom: 40 }, children: brandName }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
    ...
    websiteUrl && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { marginTop: 24, fontSize: 20, color: "#ffffff", opacity: 0.6 }, children: websiteUrl })
  ] }) });
};
const ToolShowcase = (props) => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: props.primaryColor, fontFamily: "system-ui, sans-serif" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      BackgroundLayer,
      {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 45, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(KineticIntro, { headline: props.kineticHeadline, accentColor: props.accentColor }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 45, durationInFrames: 75, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(ScreenshotShowcase, { urls: props.screenshotUrls, styleMode: props.styleMode }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 120, durationInFrames: 30, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ClosureScene,
      {
...
;// ./src/remotion/compositions/LongFormVideo.tsx
...
const calculateLongFormMetadata = ({ props }) => {
  const durationInFrames = INTRO_FRAMES + props.clipUrls.length * CLIP_FRAMES + OUTRO_FRAMES;
  return { durationInFrames };
};
const LongFormVideo_IntroScene = ({ brandName, headline, accentColor, logoUrl }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps, width } = (0,esm.useVideoConfig)();
  const brandSlide = (0,esm.spring)({ frame, fps, config: { damping: 14, stiffness: 160 } });
  const headlineSpring = (0,esm.spring)({ frame: frame - 12, fps, config: { damping: 12, stiffness: 180 } });
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 22, fontWeight: 700, color: "#ffffff", opacity: 0.75, letterSpacing: 4, textTransform: "uppercase" }, children: brandName })
            ]
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { textAlign: "center" }, children: words.map((word, i) => {
          const wordSpring = (0,esm.spring)({
            frame: frame - 18 - i * 5,
            fps,
...
const ClipScene = ({ clipUrl, sceneTitle, brandName, accentColor, sceneIndex, totalScenes }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps, width, height } = (0,esm.useVideoConfig)();
  ...
  const overlaySlide = (0,esm.spring)({ frame: frame - 8, fps, config: { damping: 16, stiffness: 180 } });
  const overlayY = (1 - overlaySlide) * 30;
  const sceneNumOpacity = (0,esm.interpolate)(frame, [0, 8, 40, 50], [0, 1, 1, 0], {
...
const OutroScene = ({ brandName, ctaText, websiteUrl, tagline, accentColor }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const reveal = (0,esm.spring)({ frame, fps, config: { damping: 14, stiffness: 140 } });
  const ctaSpring = (0,esm.spring)({ frame: frame - 15, fps, config: { damping: 12, stiffness: 160 } });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { alignItems: "center", justifyContent: "center", flexDirection: "column", gap: 20 }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      "div",
      {
        style: {
        ...
        children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 18, fontWeight: 700, color: "rgba(255,255,255,0.6)", letterSpacing: 4, textTransform: "uppercase" }, children: brandName }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 64, fontWeight: 900, color: "#ffffff", lineHeight: 1 }, children: tagline })
        ]
      }
    ),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          ...
          websiteUrl && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 16, color: "rgba(255,255,255,0.5)", letterSpacing: 1 }, children: formatWebsiteLabel(websiteUrl) })
        ]
      }
    )
  ] });
};
const LongFormVideo = (props) => {
  const {
    brandName,
    headline,
    tagline,
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: INTRO_FRAMES, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          LongFormVideo_IntroScene,
          {
            brandName,
            headline,
            accentColor,
        ...
        clipUrls.map((url, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
          esm.Sequence,
          {
...
const BrandedSlideshowComp = BrandedSlideshow;
const ToolShowcaseComp = ToolShowcase;
const LongFormVideoComp = LongFormVideo;
const calculateLongFormCompositionMetadata = (options) => calculateLongFormMetadata({
  ...options,
...
var VisualModeOverridesContext = react__WEBPACK_IMPORTED_MODULE_0__.createContext({
  dragOverrides: {},
  setDragOverrides: () => {
...
var SequenceManagerProvider = ({ children, visualModeEnabled }) => {
  ...
  const setDragOverrides = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((sequenceId, key, value) => {
  ...
  const clearDragOverrides = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((sequenceId) => {
    setControlOverrides((prev) => {
      if (!prev[sequenceId]) {
        return prev;
      }
  ...
  const setCodeValues = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((sequenceId, values) => {
  ...
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(SequenceManager.Provider, {
    ...
    children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(SequenceVisibilityToggleContext.Provider, {
      value: hiddenContext,
      children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(VisualModeOverridesContext.Provider, {
...
var PremountedPostmountedSequenceRefForwardingFunction = (props, ref) => {
  ...
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(PremountContext.Provider, {
    value: premountContextValue,
    children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(Freeze, {
      frame: freezeFrame,
  ...
  const lazy = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    if ("component" in compProps) {
      ...
      const Wrapper = (props2) => {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0__.createElement(Comp, props2);
      };
      return Wrapper;
    }
...
var useSchema = (schema, currentValue) => {
  const env = useRemotionEnvironment();
  const earlyReturn = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
  ...
  const [overrideId] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(() => String(Math.random()));
  const {
    visualModeEnabled,
    dragOverrides: overrides,
    codeValues
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(VisualModeOverridesContext);
...
var useSequenceControlOverride = (key) => {
  ...
  const { dragOverrides: overrides } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(VisualModeOverridesContext);
  if (!seqContext) {
    return;
  }
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunknextn"] = self["webpackChunknextn"] || [];
