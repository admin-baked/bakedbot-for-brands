						...
						<div class="post-single-meta">
							<ul>
								...
								<li><i class="fa-solid fa-tag"></i>
									<?php
										printf( '%s %s', esc_html( '', 'inclub' ), get_the_category_list(', ') );
									?>
								</li>
							</ul>
						</div>
			...
			<div class="row">
				...
				<div class="<?php echo esc_attr( $column ); ?>">
					<div class="post-content">
						<div class="post-entry inclub-block-style">
							<?php the_content(); ?>
							<?php wp_link_pages(); ?>
						</div>
						...
						<div class="row align-items-center">
							<div class="col-lg-8">
								<div class="post-tags">
								<?php the_tags( '<span class="tag-links">' . esc_html__( 'Tags:', 'inclub' ), '', '</span>' ); ?>
								</div>
							</div>

							<div class="col-lg-4">
								<?php do_action('inclub_action_social_sharing'); ?>
							</div>
						</div>
					</div>
					<?php 
