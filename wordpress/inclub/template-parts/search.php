			...
			<div class="container">
				...
				<?php if ( have_posts() ) : ?>
						...
						<div class="post-item <?php if ( ! has_post_thumbnail() ) { echo 'notimage'; } ?>">
							...
							<div class="post-item-body">
								...
								<div class="post-item-btn">
									...
									<?php
										printf( '<a class="readmore-btn" href="%s">%s</a>', esc_url( $post_link ), __('Read more','inclub'));
									?>
					...
					<div class="col-md-12 text-center">
							...
							<p><?php echo esc_html__( 'It seems we can\'t find what you\'re looking for.', 'inclub' ); ?></p>
