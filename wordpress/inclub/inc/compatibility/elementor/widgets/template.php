...
class inclub_widget_template extends Widget_Base {
	...
	public function get_name() {
		return 'inclub-elementor-template';
	}

	public function get_title() {
		return __( 'Inclub - Template', 'inclub' );
	}
	...
	public function get_keywords() {
		return [ 'inclub', 'elementor', 'template', 'load' ];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_general',
			[
				'label' => esc_html__( 'General', 'inclub' ),
			]
		);
		...
		$this->add_control(
			'select_template',
			array(
				'label' => esc_html__( 'Select Template', 'inclub' ),
