 ...
 * @since 1.0.0
 */
class inclub_widget_site_Logo extends Widget_Base {
	...
	public function get_title() {
		return __( 'Inclub - Site Logo', 'inclub' );
	}
	...
	protected function register_content_site_logo_controls() {
		...
		$this->add_responsive_control(
			'align',
			array(
				'label'              => __( 'Alignment', 'inclub' ),
				'type'               => Controls_Manager::CHOOSE,
				'options'            => array(
					'left'   => array(
						'title' => __( 'Left', 'inclub' ),
						'icon'  => 'eicon-text-align-left',
					),
					'center' => array(
						'title' => __( 'Center', 'inclub' ),
						'icon'  => 'eicon-text-align-center',
					),
					'right'  => array(
						'title' => __( 'Right', 'inclub' ),
		...
		$this->add_control(
			'caption',
			array(
				'label'       => __( 'Custom Caption', 'inclub' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => '',
				'placeholder' => __( 'Enter caption', 'inclub' ),
				'condition'   => array(
					'caption_source' => 'yes',
				),
				'dynamic'     => array(
		...
		$this->add_control(
			'link_to',
			array(
				'label'   => __( 'Link', 'inclub' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => array(
					'default' => __( 'Default', 'inclub' ),
					'none'    => __( 'None', 'inclub' ),
					'file'    => __( 'Media File', 'inclub' ),
					'custom'  => __( 'Custom URL', 'inclub' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'placeholder' => __( 'https://your-link.com', 'inclub' ),
				'condition'   => array(
					'link_to' => 'custom',
				),
				'show_label'  => false,
	...
	protected function register_site_logo_styling_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'          => array(
					'{{WRAPPER}} .ata-site-logo img' => 'max-height: {{SIZE}}{{UNIT}};',
				),
				'frontend_available' => true,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Background Color', 'inclub' ),
		...
		$this->add_control(
			...
			array(
				'label'       => __( 'Border Style', 'inclub' ),
				'type'        => Controls_Manager::SELECT,
				'default'     => 'none',
				'label_block' => false,
				'options'     => array(
					'none'   => __( 'None', 'inclub' ),
					'solid'  => __( 'Solid', 'inclub' ),
					'double' => __( 'Double', 'inclub' ),
					'dotted' => __( 'Dotted', 'inclub' ),
					'dashed' => __( 'Dashed', 'inclub' ),
				),
				'selectors'   => array(
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Transition Duration', 'inclub' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'max'  => 3,
		...
		$this->add_control(
			'hover_animation',
			array(
				'label' => __( 'Hover Animation', 'inclub' ),
	...
	protected function render() {
		...
		if ( home_url() . '/wp-includes/images/media/default.png' === $site_image ) {
			$site_image = home_url() . '/wp-content/plugins/elementor/assets/images/placeholder.png';
		} else {
		...
		if ( home_url() . '/wp-includes/images/media/default.png' === $image_url ) {
			$image_url = home_url() . '/wp-content/plugins/elementor/assets/images/placeholder.png';
		} else {
			$image_url = $image_url;
		}
		...
		$image_unset = home_url() . '/wp-content/plugins/elementor/assets/images/placeholder.png';
