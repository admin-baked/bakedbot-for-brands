...
/*
* Secondary Image Meta box for post, page , project
*/
class inclub_secondary_image_meta_box
{

    public static function add()
    {
        // define post types to show
        $screens = ['post', 'page', 'awaiken-project'];

        foreach ($screens as $screen) {

            add_meta_box(
                'awaiken_secondary_image',
                __('Header Background Image', 'inclub-theme-addons'),
    ...
    public static function post_page_icon_html( $post )
    {
		...
		<p><?php _e('Header background image is intended for pages that are not created using Elementor.', 'inclub-theme-addons'); ?></p>
    ...
    {
        wp_enqueue_script('awaiken-meta-media', INCLUB_ADDONS_URL . 'assets/js/meta-media.js', '', false, true);
    }
...
add_action('add_meta_boxes', ['inclub_secondary_image_meta_box', 'add']);
add_action('save_post', ['inclub_secondary_image_meta_box', 'save']);