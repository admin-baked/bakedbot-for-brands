...
import { ArrowRight, CheckCircle, Store, Users, BotMessageSquare } from 'lucide-react';
...
const features = [
  {
    ...
    name: 'AI Budtender',
    description: 'Provide expert, compliant product recommendations with our intelligent chatbot, Smokey.',
  },
  {
    icon: <Store className="h-6 w-6 text-primary" />,
    name: 'Headless Menu',
    description: 'Own your customer experience with a customizable, embeddable menu for your brand website.',
  },
  {
    icon: <Users className="h-6 w-6 text-primary" />,
    name: 'Unified Customer View',
    description: 'Consolidate customer interactions from all your retail partners into a single view.',
  },
]
