...
4. **Directly edit the code** to fix every real problem. Skip false positives without arguing.
5. Run `npm run check:types` to verify fixes don't break the build.
6. Summarize what was changed in a brief report.

## When This Runs

This workflow runs **automatically** after completing any code work — before committing. It is the final quality gate.
