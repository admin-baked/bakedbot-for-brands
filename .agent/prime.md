...
Key completed: [Dispense/AIQ image scraper + reusable onboarding script] (`scrape-dispense-full.mjs`), [THC%/strainType backfill from Alleaves — 878 products labeled] (`backfill-thc-straintype.mjs`)
